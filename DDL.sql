...
CREATE TABLE `activity` (
  ...
  CONSTRAINT `activity_ibfk_1` FOREIGN KEY (`weekday_id`) REFERENCES `weekday` (`id`)
...
CREATE TABLE `weekday` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `weekday_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-11-06 18:00:12
